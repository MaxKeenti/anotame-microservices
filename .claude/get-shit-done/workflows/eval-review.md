...
```bash
AUDITOR_MODEL=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/moonstone/Source/Personal/anotame-microservices/.claude/agents/gsd-eval-auditor.md for instructions.
