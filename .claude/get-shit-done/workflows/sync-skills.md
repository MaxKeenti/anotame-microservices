...
INSTALL_JS_GLOBAL="/Users/moonstone/Source/Personal/anotame-microservices/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/moonstone/Source/Personal/anotame-microservices/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
