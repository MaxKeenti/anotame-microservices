...
export default function OrderDetailsPage({ params, searchParams }: {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* Order Notes */}
      {order.notes && (
        <div className="bg-warning/10 p-4 rounded-xl border border-warning/20 text-warning-foreground">
      ...
      <div className="flex justify-between pt-4 border-t border-border">
        <button
          ...
          className="px-4 py-2 text-destructive hover:bg-destructive/10 rounded-lg font-medium transition-colors"
        >
          Cancelar Pedido
        </button>
