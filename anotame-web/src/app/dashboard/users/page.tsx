      ...
      <Table>
        ...
        <TableBody>
          {isLoading ? (
            ...
            users.map((u) => (
              <TableRow key={u.id}>
                <TableCell className="px-6 font-medium text-foreground">{u.firstName} {u.lastName}</TableCell>
                <TableCell className="px-6">{u.username}</TableCell>
                <TableCell className="px-6">{u.email}</TableCell>
                <TableCell className="px-6">{u.role}</TableCell>
