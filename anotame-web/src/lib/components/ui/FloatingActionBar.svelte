...
<div
  ...
  class="pointer-events-auto flex items-center gap-3 bg-background/60 backdrop-blur-xl border border-border/50 rounded-[12px] shadow-2xl px-4 py-2 max-w-[calc(100vw-2rem)] overflow-x-auto no-scrollbar"
>
