...
<div
  ...
  class="sticky bottom-6 mx-auto w-max z-50 max-w-[calc(100vw-2rem)] overflow-x-auto flex items-center gap-3 bg-card border border-border rounded-xl shadow-lg px-4 py-2"
>
