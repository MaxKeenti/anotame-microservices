...
--
-- Name: tco_order_item_service; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.tco_order_item_service (
    id_item_service uuid DEFAULT gen_random_uuid() NOT NULL,
...
ALTER TABLE public.tco_order_item_service OWNER TO admin;
...
--
-- Name: tco_order_item_service tco_order_item_service_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tco_order_item_service
    ADD CONSTRAINT tco_order_item_service_pkey PRIMARY KEY (id_item_service);
...
--
-- Name: tco_order_item_service tco_order_item_service_id_order_item_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tco_order_item_service
    ADD CONSTRAINT tco_order_item_service_id_order_item_fkey FOREIGN KEY (id_order_item) REFERENCES public.tco_order_item(id_order_item) ON DELETE CASCADE;


--
-- Name: tco_order_item_service tco_order_item_service_id_service_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tco_order_item_service
    ADD CONSTRAINT tco_order_item_service_id_service_fkey FOREIGN KEY (id_service) REFERENCES public.cci_service(id_service);
...
-- Phase 3 DATA-02: collision-free ticket number sequence (applied to Railway via sequence-migration.sql)
