...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Dobladillo a máquina', 'Ajuste de largo cosido a máquina', 15, 80.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Pantalón'), true),
    ...
    ('Colocar botón metal', 'Instalación de botón metálico', 5, 20.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Pantalón'), true),
    ('Colocar botón plastico', 'Instalación de botón de plástico', 5, 10.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Pantalón'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Colocar botón', 'Instalación de botón', 5, 10.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Blusa'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Ajuste de costado con mangas puño y dobladillo a máquina', 'Ajuste completo lateral mangas puños y largo', 90, 270.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Camisa'), true),
    ...
    ('Dobladillo a máquina y subir puño', 'Ajuste de largo a máquina y posición de puños', 45, 145.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Camisa'), true),
    ('Dobladillo a máquina faldilla', 'Ajuste de largo de faldilla a máquina', 20, 85.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Camisa'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Poner botónes x pieza', 'Instalación de un botón', 5, 15.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Saco'), true),
    ('Cambio de botónes', 'Reemplazo de todos los botónes del saco', 30, 130.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Saco'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Poner botónes', 'Instalación de múltiples botónes', 30, 75.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Vestido'), true),
    ...
    ('Reforzar botónes', 'Costura de refuerzo en botónes existentes', 20, 70.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Vestido'), true)
ON CONFLICT ON CONSTRAINT uq_service_name_garment_type DO UPDATE SET
    description = EXCLUDED.description,
    default_duration_min = EXCLUDED.default_duration_min,
    base_price = EXCLUDED.base_price,
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Poner cierres con broches de presión', 'Instalación de cremallera combinada con botónes a presión', 90, 100.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Chamarra'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Dobladillo a máquina', 'Ajuste de largo cosido a máquina', 30, 120.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Abrigo'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Cortar ruedo y dobladillo a máquina', 'Reducción de largo y dobladillo a máquina', 30, 80.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Licras'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Dobladillo a máquina', 'Ajuste de largo cosido a máquina', 15, 85.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Playera'), true),
    ('Dobladillo a máquina con aberturas', 'Ajuste de largo con acabado de aberturas laterales', 30, 110.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Playera'), true),
...
-- pans (19 services)
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ('Dobladillo a máquina', 'Ajuste de largo cosido a máquina', 15, 80.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Pans'), true),
    ...
    ('Poner broches', 'Instalación de botónes de presión o broches', 10, 40.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Pans'), true),
...
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ...
    ('Dobladillo a máquina', 'Ajuste de largo cosido a máquina', 15, 80.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Short'), true)
ON CONFLICT ON CONSTRAINT uq_service_name_garment_type DO UPDATE SET
    description = EXCLUDED.description,
    default_duration_min = EXCLUDED.default_duration_min,
    base_price = EXCLUDED.base_price,
...
-- mantel (2 services)
INSERT INTO cci_service (name, description, default_duration_min, base_price, id_garment_type, is_active) VALUES
    ('Dobladillo mantel a máquina', 'Costura de bordes a máquina para mantel', 45, 120.00, (SELECT id_garment_type FROM cci_garment_type WHERE name = 'Mantel'), true),
