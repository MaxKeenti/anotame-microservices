...
<required_reading>
@/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/moonstone/Source/Personal/anotame-microservices/.gemini
                  → checks /Users/moonstone/Source/Personal/anotame-microservices/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done
                  → writes to /Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/hooks/
...
@/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
