...
<required_reading>
@/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/references/ai-frameworks.md
@/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/references/ai-evals.md
</required_reading>
...
```bash
SELECTOR_MODEL=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-framework-selector --raw)
RESEARCHER_MODEL=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ai-researcher --raw)
DOMAIN_MODEL=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-domain-researcher --raw)
PLANNER_MODEL=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-planner --raw)
```

Check config:
```bash
AI_PHASE_ENABLED=$(node "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/bin/gsd-tools.cjs" config-get workflow.ai_integration_phase 2>/dev/null || echo "true")
```
...
```markdown
Read /Users/moonstone/Source/Personal/anotame-microservices/.gemini/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/moonstone/Source/Personal/anotame-microservices/.gemini/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/moonstone/Source/Personal/anotame-microservices/.gemini/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/moonstone/Source/Personal/anotame-microservices/.gemini/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/moonstone/Source/Personal/anotame-microservices/.gemini/agents/gsd-eval-planner.md for instructions.
