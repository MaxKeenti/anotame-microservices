...
- Saves timestamped note to `.planning/notes/` (or `/Users/maximilianogonzalezcalzada/Library/Mobile Documents/com~apple~CloudDocs/source/personal/anotame-microservices/.gemini/notes/` globally)
