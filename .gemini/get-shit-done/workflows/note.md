...
- **Global scope**: `/Users/moonstone/Source/Personal/anotame-microservices/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/moonstone/Source/Personal/anotame-microservices/.gemini/notes/`)
...
2. Glob `/Users/moonstone/Source/Personal/anotame-microservices/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/moonstone/Source/Personal/anotame-microservices/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/moonstone/Source/Personal/anotame-microservices/.gemini/notes/` — works in any directory
