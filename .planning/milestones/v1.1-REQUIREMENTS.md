...
- [x] **FE-01**: Catalog garments page uses `DataTableWrapper` — migrated from raw table markup to the standardized TanStack Table wrapper
- [x] **FE-02**: Catalog services page uses `DataTableWrapper`
- [x] **FE-03**: Catalog price lists page uses `DataTableWrapper`
- [x] **FE-04**: Admin users page uses `DataTableWrapper`
