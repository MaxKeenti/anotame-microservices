...
- ✅ **v1.1 Production Stability** — Phases 8–9 (shipped 2026-04-03)
...
- [x] **Phase 8: Production Bug Fixes** - Fix KPI dashboard API path, customers page reactive loop, and FK constraint error messaging
- [x] **Phase 9: DataTableWrapper Pattern Completion** - Migrate garments, services, price lists, and admin users pages to the standardized TanStack Table wrapper
