...
- [x] 06-02-PLAN.md — Create db/migration directories in all 4 services; populate V1__baseline.sql from live DB pg_dump (checkpoint: human must run pg_dump)
- [x] 06-03-PLAN.md — Convert repo-root migration.sql to V2__add_unit_price_to_order_item.sql in sales-service; delete original
- [x] 06-04-PLAN.md — Staging validate gate: provision local Docker PostgreSQL staging DB, restore schema dump, start all 4 services, confirm 4 history tables and no Flyway errors
